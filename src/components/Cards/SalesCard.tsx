...
const SalesCard = () => {
  ...
  <div className="flex justify-between items-center mb-4">
    <h4 className="text-gray-800 text-sm">SALES</h4>
    <Image alt="refresh" src={refresh} className="h-4 w-auto mr-4" />
    <p className="ml-1 text-sm text-gray-500">Last 30 days</p>
  ...
  {/* Data Update Info */}
  <p className="text-gray-700 text-sm">Data updated a few seconds ago</p>
