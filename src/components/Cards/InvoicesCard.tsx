  ...
  return (
    <div className="p-4 bg-white rounded-lg border border-gray-200 h-full shadow-md">
      ...
      <div className="flex justify-between items-center mb-8">
        <h4 className="text-sm  text-gray-800" style={{fontFamily:'Roboto'}}>INVOICES</h4>
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="flex-1 pr-4">
          <h5 className="text-l font-semibold text-Black-500 mb-2" style={{fontFamily:'Roboto'}}>Send personalized invoices</h5>
          <p className="text-xs text-gray-500 mb-8" style={{fontFamily:'Roboto'}}>
          Create, send, receive your payment, start again. 
          Create an invoice to get started
          </p>
          <button             style={{ backgroundColor: colors.primary, width:"100%" ,fontFamily:'Roboto'}}
 className="px-4 py-1 text-white text-sm font-semibold rounded ">
            Create an invoice 
          </button>
        </div>
